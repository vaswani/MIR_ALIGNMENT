...
class hmm : public model2
{
 ...
 public:
  ...
  //@ASHISH VASWANI: ADDED TWO FUNCTIONS. ONE TO RUN THE E-STEP
  //AND ONE TO PRINT THE REPORTS
  ...
  void printTableAndReport(int it,
    string model_prefix);
  ...
  void em_loop(Perplexity& perp, sentenceHandler& sHandler1, bool dump_files, 
	       const char* alignfile, Perplexity&, bool test,bool doInit,int iter,vector<Array<double> > &posteriors);
